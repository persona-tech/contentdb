...
//  @Test
  ...
  public void testSolrMatrix() throws Exception {
    ...
    SolrMatrix matrix = new SolrMatrix(new SolrFieldMatrix[]{matrix1, matrix2, matrix3});
